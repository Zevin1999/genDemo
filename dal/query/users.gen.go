...
func newUser(db *gorm.DB) user {
	...
	_user.ApplicationID = field.NewString(tableName, "application_id")
	_user.Mobile = field.NewString(tableName, "mobile")
	_user.Name = field.NewString(tableName, "name")
	_user.IsDeleted = field.NewBool(tableName, "is_deleted")
	_user.CreatedOn = field.NewInt32(tableName, "created_on")
	_user.UpdatedOn = field.NewInt32(tableName, "updated_on")
	_user.DeletedOn = field.NewInt32(tableName, "deleted_on")
...
type user struct {
	...
	CreatedOn      field.Int32
	UpdatedOn      field.Int32
	DeletedOn      field.Int32
...
func (u *user) updateTableName(table string) *user {
	...
	u.ApplicationID = field.NewString(table, "application_id")
	u.Mobile = field.NewString(table, "mobile")
	u.Name = field.NewString(table, "name")
	u.IsDeleted = field.NewBool(table, "is_deleted")
	u.CreatedOn = field.NewInt32(table, "created_on")
	u.UpdatedOn = field.NewInt32(table, "updated_on")
	u.DeletedOn = field.NewInt32(table, "deleted_on")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["updated_on"] = u.UpdatedOn
